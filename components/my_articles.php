        ...
        <div class="main_articles">
            <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                <div class="card" style="width: 18rem;">
                    ...
                    <div class="icons">
                        <a href="my_articles.php?del=<?php echo $row['id']; ?>"<i class="fa-regular fa-trash-can"></i></a>
                        <a href="update_articles.php?update=<?php echo $row['id']; ?>"<i class="fa-regular fa-pen-to-square"></i></a>
                    </div>
                </div>
                <?php fclose($myfile); ?>
            <?php } ?>
